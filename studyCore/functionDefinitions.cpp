        ...
        if (verifyLogin(username, password)) {
            ...
            while (true) {
                ...
                if (choice == 1) {
                    ...
                    // Fix: Ensure username matches before password reset
                    if (enteredPIN == recoveryPIN && username == storedUsername) {
                        while (true) {
                        ...
                        ofstream outFile("credentials.txt"); // Overwrite with correct user details
                        outFile << storedUsername << endl << password << endl << recoveryPIN;
                        outFile.close();
                        system("cls");
